...
public:
    ...
    void onPlay(cocos2d::CCObject* pSender) {
        ...
        levelSelect->addChild(LevelSelectLayer::create(0));
    ...
    void onUpdateHttpResponse(CCHttpClient* client, CCHttpResponse* response) {
        ...
        if (responseString != ModBase::version && response->getResponseCode() == 200) {
        ...
        if (response->getResponseCode() != 200) {
            ...
            AchievementBar* AchievementBar_ = AchievementBar::create(
                "Server problems!",
            ...
            discordBtn->CCMenuItemSpriteExtra::setScale(1.8f);
            ...
            AchievementNotifier::sharedState()->m_pQueue->addObject(AchievementBar_);
            if (!AchievementNotifier::sharedState()->m_pCurrentAchievement) {
...
inline bool(__cdecl* GJGarageLayer_init)(GJGarageLayerExt*);
bool __fastcall GJGarageLayer_init_H(GJGarageLayerExt* self) {
    ...
    //saiSwingAttition
    CCObject* saiSwingAttitionObj = self->m_pTabToggleSpider->getParent()->getChildren()->objectAtIndex(7);//getObj
    //if nullptr so replaces by nonomaeshitnoonewants thing
    CCMenuItemToggler* saiSwingAttition = saiSwingAttitionObj ? reinterpret_cast<CCMenuItemToggler*>(saiSwingAttitionObj) : CCMenuItemToggler::create(CCNode::create(), CCNode::create(), self, nullptr);
    saiSwingAttition->setTarget(self, menu_selector(GJGarageLayerExt::onSwings));
    return true;
}

inline void(__thiscall* GaragePage_onSelect)(GJGarageLayerExt*, cocos2d::CCObject*);
void __fastcall GaragePage_onSelect_H(GJGarageLayerExt* self, void*, cocos2d::CCObject* bruh) {
    GaragePage_onSelect(self, bruh);
    ModBase::saveIcons();
}

inline void(__thiscall* GaragePage_onBack)(GJGarageLayerExt*, cocos2d::CCObject*);
void __fastcall GaragePage_onBack_H(GJGarageLayerExt* self, void*, cocos2d::CCObject* bruh) {
    GaragePage_onBack(self, bruh);
    ModBase::saveIcons();
}
...
void CreateGameLayersHooks() {
    ...
    HOOK(base + 0x12BD40, GaragePage_onSelect, false);
    HOOK(base + 0x12ADF0, GaragePage_onBack, false);
