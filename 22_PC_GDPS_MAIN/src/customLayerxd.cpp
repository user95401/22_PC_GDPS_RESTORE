...
void customLayerxd::openURLcredits(CCObject* sender) { CCApplication::sharedApplication()->openURL("http://gdps22pc.7m.pl/credits.php"); }
...
void customLayerxd::openURL(CCObject* sender) { CCApplication::sharedApplication()->openURL("http://gdps22pc.7m.pl"); }
